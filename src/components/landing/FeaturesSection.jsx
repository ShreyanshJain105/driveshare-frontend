import { ArrowUpCircle, BarChart2, Download, FileText, Folder, History, Lock, Share2, ShieldCheck, Upload, Wallet } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
                        DriveShare delivers all the tools required to efficiently manage your digital content.
                    </p>
                </div>
                <div className="mt-16">
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                        {features.map((feature, index) => (
                            <div key={index} className="pt-5 border vorder-gray-100 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 bg-white">
